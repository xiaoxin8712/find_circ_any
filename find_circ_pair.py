#!/usr/bin/env python
# These codes are adapted from find_circ.py to identify circRNAs from 
# any genomic loci without restriction of splicing signal from paired-end RNA-seq.
import os
import sys
import re
import mmap
